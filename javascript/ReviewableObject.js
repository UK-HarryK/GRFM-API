...
module.exports = class ReviewableObject{
    ...
    static insertLP = ReviewableObject.db.prepare("INSERT OR IGNORE INTO lps (title, artist, releaseDate, description, artURL, genre, avgScore, numReviews) VALUES (?, ?, ?, ?, ?, ?);")
    static insertEP = ReviewableObject.db.prepare("INSERT OR IGNORE INTO eps (title, artist, releaseDate, description, artURL, genre, avgScore, numReviews) VALUES (?, ?, ?, ?, ?, ?);")
    static insertSingle = ReviewableObject.db.prepare("INSERT OR IGNORE INTO singles (title, artist, releaseDate, description, artURL, genre, avgScore, numReviews) VALUES (?, ?, ?, ?, ?, ?);")
