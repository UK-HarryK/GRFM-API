...
db.prepare("CREATE TABLE IF NOT EXISTS lps (title TEXT, artist TEXT, releaseDate TEXT, description TEXT, artURL TEXT, genre TEXT, avgReview INTEGER, numReviews INTEGER)").run()
...
db.prepare("CREATE TABLE IF NOT EXISTS eps (title TEXT, artist TEXT, releaseDate TEXT, description TEXT, artURL TEXT, genre TEXT, avgReview INTEGER, numReviews INTEGER)").run()
...
db.prepare("CREATE TABLE IF NOT EXISTS singles (title TEXT, artist TEXT, releaseDate TEXT, description TEXT, artURL TEXT, genre TEXT, avgReview INTEGER, numReviews INTEGER)").run()
